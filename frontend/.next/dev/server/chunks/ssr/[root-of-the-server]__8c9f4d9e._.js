...
async function DepartmentPage({ params }) {
    ...
    const allDepartments = await __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$api$2f$query$2d$client$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["queryClient"].ensureQueryData({
        ...
        queryFn: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$entities$2f$departments$2f$api$2f$departments$2e$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["departmentsApi"].getDepartments()
    });
    const department = allDepartments?.find((dept)=>dept.id.toString() === id);
    if (!department) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8c9f4d9e._.js.map